#!/usr/bin/env python3
"""
This script directly modifies the minimize.py file to fix the scalar energy value indexing errors.
"""

import re

def fix_minimize_py():
    """Write the whole file with fixes applied"""
    with open('src/fennol/md/minimize.py', 'w') as f:
        f.write('''import sys, os, io
import argparse
import time
...
def minimize_system(model, system_data, conformation, simulation_parameters, fprec):
    ...
    print('Written fixed code to minimize.py')
