...
# Restraints section
restraints {
  # Distance restraint between Mg and an oxygen
  mg_o_restraint {
    type = distance
    atom1 = 565  # Mg ion at line 566 (0-indexed is 565)
    atom2 = 543  # Changed to a nearby oxygen atom for testing
    target = 3.0
    force_constant = 50.0  # Increased force constant for more visible effect
    style = harmonic  # Changed to harmonic for simplicity
  }  
}
