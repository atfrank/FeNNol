...
# Restraints section with both harmonic and flat-bottom restraints
restraints {
  # Harmonic restraint for comparison
  harmonic_restraint {
    type = distance
    atom1 = 10
    atom2 = 100
  ...
  flatbottom_restraint {
    ...
    force_constant = 5.0
    style = flat_bottom
    tolerance = 2.0  # Allow 2Å of movement without penalty
  }
}

# Collective variables to track all distances
colvars {
  harmonic_distance {
    type = distance
    atom1 = 10
