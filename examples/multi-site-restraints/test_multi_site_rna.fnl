...
dt[fs] = 0.5
traj_format pdb
pdb_reference = /home/aaron/ATX/software/ATF-FeNNol/FeNNol/examples/multi-site-restraints/focus_premod_mini.pdb
...
restraints {
   ...
   multi_site_rna {
      ...
      nucleophiles = 100, 186, 47        # Your nucleophilic sites (e.g., 2'-OH, N7, N3)
      carbon = 129                              # Index of electrophilic carbon on warhead
      leaving_group = 137                      # Index of leaving group (optional - will auto-detect)
      ...
      target_distance = 2.0                   # Target Nu-C distance in Angstroms (optional)
  ...
  topology_rmsd {
    ...
    prevent_side_reactions {
      ...
      atom_pairs = 129, 128, 137, 128, 129, 3, 129, 2, 128, 1, 128, 127, 127, 136, 136, 125, 127, 166, 127, 167
