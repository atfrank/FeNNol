...
xyz_input{
  file /home/aaron/ATX/software/ATF-FeNNol/FeNNol/examples/multi-site-restraints/focus_premod_mini_spiro.xyz
  indexed no
...
dt[fs] = 0.5
traj_format pdb
pdb_reference = /home/aaron/ATX/software/ATF-FeNNol/FeNNol/examples/multi-site-restraints/focus_premod_mini_spiro.pdb
...
restraints {
   ...
   multi_site_rna {
      ...
      nucleophiles = 96, 44, 177        # Your nucleophilic sites (e.g., 2'-OH, N7, N3)
      carbon = 208                              # Index of electrophilic carbon on warhead
      leaving_group = 207                      # Index of leaving group (optional - will auto-detect)
      ...
      target_distance = 2.5                   # Target Nu-C distance in Angstroms (optional)
      base_distance_force_constant = 0.01      # Force constant for distance (optional)

      # Weighting parameters
      weighting_mode = geometry                 # "distance", "geometry", or "hybrid"
  ...
  topology_rmsd {
    ...
    target_rmsd = 0.0
    force_constant = 0.1
    reference_file = /home/aaron/ATX/software/ATF-FeNNol/FeNNol/examples/multi-site-restraints/focus_premod_mini_spiro.pdb
    atom_selection {
      residue_names = C, G, A, U, CUT
    }
    style = flat_bottom
    tolerance = 1.5
  }
    ...
    prevent_side_reactions {
      ...
      atom_pairs = 207, 202, 202, 208, 209, 211, 211, 195, 195, 198, 198, 200, 200, 202, 202, 197, 197, 196, 196, 211, 197, 204
