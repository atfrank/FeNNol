#!/usr/bin/env python3
"""
This script fixes the energy_formatter.py to properly handle energy values
"""

def fix_energy_formatter():
    """Fix the energy_formatter.py file to handle both scalar and array energy values"""
    with open('src/fennol/md/energy_formatter.py', 'w') as f:
        f.write('''"""
...
def update_final_energy_display(energy, system_data, params, max_force, rms_force):
    ...
    print("Fixed energy_formatter.py to properly handle both scalar and array energy values")

if __name__ == "__main__":
    fix_energy_formatter()