#!/usr/bin/env python3
"""
Test 3-atom force accuracy with numerical gradient
"""
...
print("="*80)
print("3-ATOM FORCE ACCURACY TEST")
print("="*80)
print()
...
for i in range(3):
    ...
    atom_rel_error = np.linalg.norm(error[i]) / np.linalg.norm(forces_numerical[i]) * 100
...
if rel_error < 1.0:
    ...
    print(f"✗ Forces have {rel_error:.1f}% error")
